...
def category_form(window):
    ...
    category_frame = Frame(window, width=1250, height=700, bg='white')
    category_frame.place(x=275, y=100)
    ...
    category_name_entry = Entry(details_frame, font=('times new roman', 14, 'bold'), bg='white')
    ...
    description_text = Text(details_frame, width=25, height=8, bd=2, bg='white')
    description_text.grid(row=2, column=1)

    button_frame = Frame(category_frame, bg='white')
    button_frame.place(x=480, y=260)
    ...
    clear_button.grid(row=0, column=2, padx=20, pady=20)



    treeview_frame = Frame(category_frame, bg='lightyellow')
    treeview_frame.place(x=550, y=340,height=250,width=500)
