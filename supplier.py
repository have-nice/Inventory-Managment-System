...
def supplier_form(window):
    global back_image
    supplier_frame = Frame(window, width=1250, height=700, bg='white')
    supplier_frame.place(x=275, y=100)

    heading_label = Label(supplier_frame, text='Manage Suppliers Details', font=('times new roman', 16, 'bold'),
                          bg='#0f4d7d', fg='white')
    ...
    description_text = Text(left_frame, width=35, height=8, bd=2, bg='white')
    ...
    right_frame.place(x=520, y=115, width=550, height=400)
    ...
    search_button = Button(search_frame, text='Search', font=('times new roman', 14), width=10, cursor='hand2',
                           fg='white', bg='#0f4d7d', command=lambda: search_supplier(search_entry.get(),treeview))
    search_button.grid(row=0, column=2, padx=15)

    show_button = Button(search_frame, text='Show All', font=('times new roman', 14), width=10, cursor='hand2',
